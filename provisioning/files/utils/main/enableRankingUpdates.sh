#!/bin/bash
#
# USO: enableRankingUpdates.sh <rankingId>
#
# Configura el Proxy Server para que envíe notificaciones de
...
enableRankingUpdates () {
  ...
  [ ! -e $configFile ] && die "Ranking $1 no encontrado."
